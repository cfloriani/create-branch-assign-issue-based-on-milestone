...
if str(os.getenv('milestone'))[0:7].lower() == "feature":
    ...
    repo.create_pull(title=branch_issue, body='body', head="develop", base="branch_milestone")
else:
    repo.create_pull(title=branch_issue, body='body', head="develop", base="master")